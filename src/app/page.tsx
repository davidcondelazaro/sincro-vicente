  ...
  return (
    <div className="min-h-screen bg-zinc-50 lg:grid lg:grid-cols-[15rem_minmax(0,1fr)]">
      <aside className="border-b border-zinc-200 bg-white px-5 py-5 lg:min-h-screen lg:border-r lg:border-b-0">
        ...
        <nav className="mt-6 flex gap-2 overflow-x-auto lg:flex-col" aria-label="Módulos de la aplicación"><a href="/" className="shrink-0 rounded-lg bg-emerald-50 px-3 py-2 text-sm font-semibold text-emerald-900">Importar un cliente</a><a href="/importaciones-masivas" className="shrink-0 rounded-lg px-3 py-2 text-sm text-zinc-600 hover:bg-zinc-50">Importaciones masivas</a><a href="/importaciones-masivas#historial" className="shrink-0 rounded-lg px-3 py-2 text-sm text-zinc-600 hover:bg-zinc-50">Ejecuciones</a><span className="shrink-0 rounded-lg px-3 py-2 text-sm text-zinc-400">Configuración <span className="ml-1 text-xs">Próximamente</span></span></nav>
      </aside>
