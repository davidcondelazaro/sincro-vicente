...
as $$ declare v_queue text; begin
  ...
  return pgmq.set_vt(v_queue, p_message_id, greatest(0, least(p_visibility_timeout, 900)));
end; $$;
revoke all on function public.renew_price_stock_import_queue_message(text,bigint,integer) from public,anon,authenticated;
grant execute on function public.renew_price_stock_import_queue_message(text,bigint,integer) to service_role;
